...
# given a board and the location of a piece (0 indexed), return a list of aavailable but not necessart moves, 
# and a list of necessart moves
def findMoves(board, x, y):
    piece = board[x][y]
    mod2 = piece%2
    availableMoves = []
    necessaryMoves = []
...
def minimax(depth, difficulty, player, board):
...
def findMovesOld(player, MyPieces, TheirPieces, x, y, isKing):
    availableMoves = []
    necessaryMoves = {}
    # if the piece can move up
